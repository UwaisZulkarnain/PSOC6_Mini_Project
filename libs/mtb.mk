...
SEARCH_capsense=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/capsense/release-v4.0.0
SEARCH_retarget-io=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/retarget-io/release-v1.10.0
SEARCH_bt-fw-mur-cyw4343w=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/bt-fw-mur-cyw4343w/release-v1.0.0
...
SEARCH_recipe-make-cat1a=$(patsubst %/,%,$(CY_GETLIBS_SHARED_PATH))/$(CY_GETLIBS_SHARED_NAME)/recipe-make-cat1a/release-v2.8.0

# Search libraries added to build
SEARCH_MTB_MK+=$(SEARCH_capsense)
SEARCH_MTB_MK+=$(SEARCH_retarget-io)
SEARCH_MTB_MK+=$(SEARCH_bt-fw-mur-cyw4343w)
...
COMPONENTS += MW_BT_FW_MUR_CYW4343W
